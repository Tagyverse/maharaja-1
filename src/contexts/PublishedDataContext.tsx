...
import { applyBrandingOverride, BrandingOverride } from '../utils/brandTheme';
    ...
    try {
      ...
      if (isPreviewMode) {
        ...
        if (firebaseData) {
          ...
          applyBrandingOverride((firebaseData as any)?.branding);
        } else {
        ...
        if (publishedData) {
          ...
          applyBrandingOverride(publishedData?.branding);
        } else {
