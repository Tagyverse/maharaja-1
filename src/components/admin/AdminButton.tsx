...
export default function AdminButton({
  ...
  const baseStyles = 'inline-flex items-center justify-center rounded-lg font-medium transition-all duration-200 border focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed';
  ...
  const variantStyles = {
    ...
    ghost: 'bg-transparent text-gray-700 border-gray-300 hover:bg-gray-100 focus:ring-gray-500',
  };
