      ...
      <div className="fixed bottom-4 sm:bottom-6 right-4 sm:right-6 z-40 pointer-events-none">
        <div className="flex flex-col items-end gap-2 sm:gap-4 pointer-events-auto">
          ...
          <button
            ...
            className={`w-11 h-11 sm:w-16 sm:h-16 bg-brand hover:bg-brand-dark text-white rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center justify-center active:scale-95 relative ${
