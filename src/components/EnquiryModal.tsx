...
export default function EnquiryModal({ isOpen, onClose }: EnquiryModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl shadow-2xl max-w-md mx-auto w-full border-t-4 border-black animate-slide-up max-h-[90dvh] overflow-y-auto">
