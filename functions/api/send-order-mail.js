...
function generateEmailHTML(order, orderId) {
      ...
      <td style="padding: 16px 12px; border-bottom: 1px solid #f3f0eb;">
        <table cellpadding="0" cellspacing="0" border="0"><tr>
          <td style="vertical-align: top; padding-right: 12px;">
            ${item.product_image ? `<img src="${item.product_image}" alt="${item.product_name}" width="56" height="56" style="width: 56px; height: 56px; object-fit: cover; border-radius: 10px; border: 1px solid #e8e4df; display: block;" />` : `<div style="width: 56px; height: 56px; background: #f9f6f2; border-radius: 10px;"></div>`}
          </td>
